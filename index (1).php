...
<body>
	...
	<div class="container ">
		...
		<h1 class="text-center " style="color:Gray; font-family: Arial,Helvetica, sans-serif;"><a href="index.php" class="tittle-link"> Monitor de Inventario </a></h1>
		...
		if (isset($_POST['buscar'])) {
			...
			if ($row_count !== 0) {
				if ($row_count > 1) {
					echo "<br><br><br> <div class='list-group list-group-flush' align='center'>";
			...
			$Muestra = "<br>
					 <div class='row box-prod'>
						 <div class='col-xs-12 col-xs-offset-0 col-sm-12 col-sm-offset-0 col-md-6  col-md-offset-0 col-lg-12 col-lg-offset-0'>
							<div >
								<div class=col-lg-4>
									<font size='4' ><strong> Código: </strong></font><br>
									<font size='6'style='color:DodgerBlue;'> $articulo </font>
								</div>
								<div class=col-lg-4>
									<font size='4'><strong>Descripción:</strong></font><br>
									<font size='6' style='color:DodgerBlue;'>$descripcion</font>
								</div>
								<div class=col-lg-4>	
									<font size='4'><strong>Existencia:</strong></font><br>
									<font size='6' style='color:DodgerBlue;'>	$existencia</font>
								</div>
							</div> <br>
							 <div class=col-lg-6>
								<!--  <font size='4'><strong><strong>Precio 1:</strong></font><br>
								<font size='6' style='color:Tomato;'>$$p1</font> -->
							 </div>";
			if ($p2 > 0) {
				$Muestra = $Muestra . " 
										<div class=col-lg-6> <font size='4'><strong>Precio 2:</strong></font><br>
		...
		function showMovimiento($ejecutarmo)
		{
			setlocale(LC_MONETARY, "es_MX");
			$count = 0;
			echo "<div class=row><table class='table table-responsive table-striped table-bordered table-hover table-sm' >
