          ...
          <?php
            ...
            if (isset($_POST['buscar'])) {
							...
							if (isset($_POST['descrip'])){
										...
										//Agregue prods.C2 y prods.C3
										$consulta = "select prods.articulo,prods.descrip,prods.imagen,
													impuestos.valor,prods.precio1,prods.precio2,prods.precio3, prods.C2, prods.C3,
													prods.precio4, prods.precio5, prods.C4, prods.C5, prods.precio6, prods.C6
													from prods inner join impuestos on prods.impuesto = impuestos.impuesto
													where prods.descrip LIKE '%$codigo%' or prods.articulo LIKE '%$codigo%' ";
							}else{
              ...
              $ejecutar = sqlsrv_query($conn_sis,$consulta,array(), array( "Scrollable" => SQLSRV_CURSOR_KEYSET ));
							...
							if ($row_count !== 0) {
									if($row_count > 1){
										...
										while ($datos = sqlsrv_fetch_array($ejecutar)) {
											...
											/**
											 *  CAMBIOS A LA HORA DE ENVIAR EL QUERY
											 */
											...
											echo "<a href='index.php?buscaArt=$articulo' class='list-group-item'>
											   $descripcion
											</a>";
										}
				 ...
				 function showArticulo($art){
					...
					//echo " ".$datos[3];
					 ...
					 $p4 = round($datos[9]*$ejecimpuestos * 100) / 100;
					 $p5 = round($datos[10]*$ejecimpuestos * 100) / 100;
					 $p6 = round($datos[13]*$ejecimpuestos * 100) / 100;
					 ...
					 <div class='row box-prod'>
						 <div class='col-xs-12 col-xs-offset-0 col-sm-12 col-sm-offset-0 col-md-6  col-md-offset-0 col-lg-8 col-lg-offset-0'>
							 <br>
								 ...
								 <br><br>
								 <font size='6'>Precio 1:</font>
								 <br>
								 <font style='color:Tomato; font-size:12rem;'>$$p1</font>
								 <br><br>";

					

								 if ($p2 > 0 ) {
									$Muestra = $Muestra."<font size='6'>Precio 2 en la compra de: <font size='6'style='color:DodgerBlue;'> $c2 </font></font>
								 <br>
								 <font style='color:Tomato; font-size:12rem;'>$$p2</font>
								 <br><br>";
								 }
								 if ($p3 >0) {
									$Muestra = $Muestra."<font size='6'>Precio 3 en la compra de: <font size='6'style='color:DodgerBlue;'> $c3 </font></font>
								 <br>
								 <font style='color:Tomato; font-size:12rem;'>$$p3</font>
								 <br><br>";
								 }
								 if ($p4 >0) {
									$Muestra = $Muestra."<font size='6'>Precio 4 en la compra de: <font size='6'style='color:DodgerBlue;'> $c4 </font></font>
								 <br>
								 <font style='color:Tomato; font-size:12rem;'>$$p4</font>
								 <br><br>";
								 }
								 if ($p5 >0) {
									$Muestra = $Muestra."<font size='6'>Precio 5 en la compra de: <font size='6'style='color:DodgerBlue;'> $c5 </font></font>
								 <br>
								 <font style='color:Tomato; font-size:12rem;'>$$p5</font>
								 <br><br>";
								 }
								 if ($p6 >0) {
									$Muestra = $Muestra."<font size='6'>Precio 6 en la compra de: <font size='6'style='color:DodgerBlue;'> $c6 </font></font>
								 <br>
								 <font style='color:Tomato; font-size:12rem;'>$$p6</font>
								 <br><br>";
								 }
					...
					if (isset($_GET['buscaArt'])) {
						...
						*/
						$consulta2 = "select prods.articulo,prods.descrip,prods.imagen,
													...
													prods.precio4, prods.precio5, prods.C4, prods.C5, prods.precio6, prods.C6
													from prods inner join impuestos on prods.impuesto = impuestos.impuesto
													where prods.articulo = '$busca_art'";
